...
public class FilterDispatcher implements Filter {
    ...
    private final String authenticationPage="authentication.html";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        //in default, if there is no request, move to login.html
        ...
        try {
            ...
            if (resource.length() > 0) {
                ...
                if (resource.equals("register")) {
                    ...
                    if (action != null) {
                        if (action.equals("Reset")) {
                            //move to ResetRegisterServlet
                            resource = "resetRegister";
                        }
                    }
                }
                ...
                //if the user hasn't login into the system, but try to do any function except login and register
                //move to the authentication page
