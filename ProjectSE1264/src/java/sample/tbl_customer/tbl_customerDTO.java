...
public class tbl_customerDTO implements Serializable{
    private String custID, password, custName,lastName, middleName,address, phone;
    private int custLevel;

    public tbl_customerDTO() {
    }

    public tbl_customerDTO(String custID, String password, String custName, String lastName, String middleName, String address, String phone, int custLevel) {
        this.custID = custID;
